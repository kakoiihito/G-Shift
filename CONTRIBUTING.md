...
> The Issues Tab should be used for bug reports, feature requests, personal support, and pull requests.

# Ground Rules

> As a contributor, your contributions need to follow this criteria in order to be properly considered.
> 
...
> If you find yourself needing a feature that doesn't exist, open an issue on GitHub which describes the feature you
